...
function partitions()
{
	...
	then
		...
		parted -s mklabel msdos mkpart primary ext4 4MiB 512MiB mkpart primary $hdd_system 512MiB 100% set 1 boot on
...
function addrelease()
{
	...
	echo "Description: ArchSploit Xisqu v2.0.5" >> /mnt/etc/archsploit/release/release.md
